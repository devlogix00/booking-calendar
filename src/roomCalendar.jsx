...
function saveDates(){
  ...
  if(rngePlus != undefined){
    updates['users/userAccount/'+userId+'/roomdata/roomDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/roomdata/datesLength'] = rngePlus;
    ...
    updates['users/userAccount/'+userId+'/roomdata'+today+'/roomDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/roomdata'+today+'/datesLength'] = rngePlus;
    updates['users/userAccount/'+userId+'/itemdata'+today+'/datesLength'] = rngePlus;
    return firebaseapp.database().ref().update(updates);
  } else {
    updates['users/userAccount/'+userId+'/roomdata/roomDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/roomdata/datesLength'] = 1;
    updates['users/userAccount/'+userId+'/bookingdata/itemDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/bookingdata/datesLength'] = 1;
    updates['users/userAccount/'+userId+'/roomdata'+today+'/roomDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/roomdata'+today+'/datesLength'] = 1;
...
function highlightDates(){
  const roomdata = db.ref('users/userAccount/'+userId+'/roomdata');
  roomdata.on('value', (snapshot) => {
    const data = snapshot.val();
    if(data != 'null'){
      let dateHolder = [];
      dateHolder = data.roomDates;
