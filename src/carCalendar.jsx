...
function saveDates(){
  ...
  if(rngePlus != undefined){
    updates['users/userAccount/'+userId+'/cardata/carDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/cardata/datesLength'] = rngePlus;
    ...
    updates['users/userAccount/'+userId+'/bookingdata'+today+'/itemDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/bookingdata'+today+'/datesLength'] = rngePlus;
    updates['users/userAccount/'+userId+'/cardata'+today+'/carDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/cardata'+today+'/datesLength'] = rngePlus;
    updates['users/userAccount/'+userId+'/itemdata'+today+'/datesLength'] = rngePlus;
    return firebaseapp.database().ref().update(updates);
  } else {
    updates['users/userAccount/'+userId+'/cardata/carDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/cardata/datesLength'] = 1;
    updates['users/userAccount/'+userId+'/bookingdata/itemDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/bookingdata/datesLength'] = 1;
    updates['users/userAccount/'+userId+'/bookingdata/'+today+'/itemDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/bookingdata/'+today+'/datesLength'] = 1;
    updates['users/userAccount/'+userId+'/cardata'+today+'/carDates'] = selectedDays;
    updates['users/userAccount/'+userId+'/cardata'+today+'/datesLength'] = 1;
...
function highlightDates(){
  const roomdata = db.ref('users/userAccount/'+userId+'/cardata');
  roomdata.on('value', (snapshot) => {
    const data = snapshot.val();
    if(data != 'null'){
      let dateHolder = [];
      dateHolder = data.carDates;
